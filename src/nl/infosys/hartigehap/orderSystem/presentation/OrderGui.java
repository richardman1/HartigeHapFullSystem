...
public class OrderGui {
     ...
     * Creates BestelGui
     *
     * @param orderManagerObj Order manger object
    ...
    private void initComponents() {
        ...
        legend.add(new JLabel("Huidige bestelling:"), BorderLayout.WEST);
        legend.add(new JLabel("Bestelling overzicht:"), BorderLayout.EAST);
        legend.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 335));

        // Create new scrollPane for the table
        scrollPane.setViewportView(createTotalList());
        scrollPane2.setViewportView(createOrderList());

        // Add legend & scrollPane with JTable to mainPanel
    ...
    /**
     * Method for showing an confirmation window to delete an product out of the
     * order list
     */
